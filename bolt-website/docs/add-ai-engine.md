...
|----------|------|------|-------------|
| **OpenAI** | GPT-4, GPT-3.5 | Pay-per-use | Cloud |
| **Azure OpenAI** | GPT-4, GPT-3.5 | Pay-per-use | Cloud |
...
> 💡 **Tip**: For the best SQL generation quality, we recommend **GPT-4** or **Claude 3 Opus**. For a free option, try **Ollama** with Llama 3 or CodeLlama.
