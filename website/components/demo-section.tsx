        ...
        <Tabs defaultValue="editor" className="mx-auto max-w-6xl">
          ...
          <TabsContent value="editor" className="mt-8">
            <Card className="overflow-hidden border-2">
              <div className="relative aspect-video bg-muted-foreground/5 dark:bg-muted">
                <Image
          ...
          <TabsContent value="assistant" className="mt-8">
            <Card className="overflow-hidden border-2">
              ...
              <div className="p-6 bg-emerald-50 dark:bg-emerald-950/30 border-t">
                <p className="text-lg font-medium text-emerald-900 dark:text-emerald-100 mb-2">
                  AI Chat Assistant
                </p>
          ...
          <TabsContent value="explorer" className="mt-8">
            <Card className="overflow-hidden border-2">
              ...
              <div className="p-6 bg-amber-50 dark:bg-amber-950/30 border-t">
                <p className="text-lg font-medium text-amber-900 dark:text-amber-100 mb-2">
          ...
          <TabsContent value="results" className="mt-8">
            <Card className="overflow-hidden border-2">
              ...
              <div className="p-6 bg-cyan-50 dark:bg-cyan-950/30 border-t">
                <p className="text-lg font-medium text-cyan-900 dark:text-cyan-100 mb-2">
                  Results Grid
                </p>
