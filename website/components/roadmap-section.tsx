...
const roadmapItems = [
  {
    ...
    description:
      "Expand database compatibility to include Oracle and MySQL connections.",
    status: "In Progress",
  },
  {
    icon: Rocket,
    ...
    description:
      "Schema versioning, migration tracking, and automated deployment tools.",
    status: "Planned",
  },
  {
    ...
    description:
      "Export results to Excel, JSON, Parquet, and other popular formats.",
    status: "Planned",
  },
  {
    icon: Users,
    ...
    description:
      "Shared snippets, team workspaces, and collaborative query development.",
    status: "Research",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          <p className="text-muted-foreground">
            ...
            <a
              href="https://github.com/victorZKov/lucedata/issues"
              target="_blank"
